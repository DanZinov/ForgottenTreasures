...
public class SaveDiamondMine : MonoBehaviour {
	...
	void Start(){
		...
		if (File.Exists (Application.persistentDataPath + "/playerInfoDiamondMine.dat")) {
			BinaryFormatter bf = new BinaryFormatter ();
			FileStream playerInfo = File.Open (Application.persistentDataPath + "/playerInfoDiamondMine.dat", FileMode.Open);
			PlayerDataDiamondMine playerInfoData = (PlayerDataDiamondMine)bf.Deserialize (playerInfo);
			playerInfo.Close ();
		...
		if (File.Exists (Application.persistentDataPath + "/ResearchTimeDiamondMine.dat")){
			BinaryFormatter bf = new BinaryFormatter ();
			FileStream researchTime = File.Open (Application.persistentDataPath + "/ResearchTimeDiamondMine.dat", FileMode.Open);
			PlayerDataDiamondMine researchTimeData = (PlayerDataDiamondMine)bf.Deserialize (researchTime);
			researchTime.Close ();
	...
	void OnApplicationPause(){
		BinaryFormatter bf = new BinaryFormatter ();
		FileStream file = File.Create (Application.persistentDataPath + "/playerInfoDiamondMine.dat");
		PlayerDataDiamondMine data = new PlayerDataDiamondMine ();
		FileStream gold = File.Create (Application.persistentDataPath + "/Gold.dat");
		Gold goldData = new Gold();
	...
	public void WhenClicked(){
		BinaryFormatter bf = new BinaryFormatter ();
		FileStream file = File.Create (Application.persistentDataPath + "/ResearchTimeDiamondMine.dat");
		PlayerDataDiamondMine data = new PlayerDataDiamondMine ();
