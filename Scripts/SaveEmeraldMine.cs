...
public class SaveEmeraldMine : MonoBehaviour {
	...
	void Start(){
		...
		if (File.Exists (Application.persistentDataPath + "/playerInfoEmeraldMine.dat")) {
			BinaryFormatter bf = new BinaryFormatter ();
			FileStream playerInfo = File.Open (Application.persistentDataPath + "/playerInfoEmeraldMine.dat", FileMode.Open);
			PlayerDataEmeraldMine playerInfoData = (PlayerDataEmeraldMine)bf.Deserialize (playerInfo);
			playerInfo.Close ();
		...
		if (File.Exists (Application.persistentDataPath + "/ResearchTimeEmeraldMine.dat")){
			BinaryFormatter bf = new BinaryFormatter ();
			FileStream researchTime = File.Open (Application.persistentDataPath + "/ResearchTimeEmeraldMine.dat", FileMode.Open);
			PlayerDataEmeraldMine researchTimeData = (PlayerDataEmeraldMine)bf.Deserialize (researchTime);
			researchTime.Close ();
	...
	void OnApplicationPause(){
		BinaryFormatter bf = new BinaryFormatter ();
		FileStream file = File.Create (Application.persistentDataPath + "/playerInfoEmeraldMine.dat");
		PlayerDataEmeraldMine data = new PlayerDataEmeraldMine ();
		FileStream gold = File.Create (Application.persistentDataPath + "/Gold.dat");
		Gold goldData = new Gold();
	...
	public void WhenClicked(){
		BinaryFormatter bf = new BinaryFormatter ();
		FileStream file = File.Create (Application.persistentDataPath + "/ResearchTimeEmeraldMine.dat");
		PlayerDataEmeraldMine data = new PlayerDataEmeraldMine ();
