...
public class SaveIronMine : MonoBehaviour {
	...
	void Start(){
		...
		if (File.Exists (Application.persistentDataPath + "/playerInfoIronMine.dat")) {
			BinaryFormatter bf = new BinaryFormatter ();
			FileStream playerInfo = File.Open (Application.persistentDataPath + "/playerInfoIronMine.dat", FileMode.Open);
			PlayerDataIronMine playerInfoData = (PlayerDataIronMine)bf.Deserialize (playerInfo);
			playerInfo.Close ();
		...
		if (File.Exists (Application.persistentDataPath + "/ResearchTimeIronMine.dat")){
			BinaryFormatter bf = new BinaryFormatter ();
			FileStream researchTime = File.Open (Application.persistentDataPath + "/ResearchTimeIronMine.dat", FileMode.Open);
			PlayerDataIronMine researchTimeData = (PlayerDataIronMine)bf.Deserialize (researchTime);
			researchTime.Close ();
	...
	void OnApplicationPause(){
		BinaryFormatter bf = new BinaryFormatter ();
		FileStream file = File.Create (Application.persistentDataPath + "/playerInfoIronMine.dat");
		PlayerDataIronMine data = new PlayerDataIronMine ();
		FileStream gold = File.Create (Application.persistentDataPath + "/Gold.dat");
		Gold goldData = new Gold();
	...
	public void WhenClicked(){
		BinaryFormatter bf = new BinaryFormatter ();
		FileStream file = File.Create (Application.persistentDataPath + "/ResearchTimeIronMine.dat");
		PlayerDataIronMine data = new PlayerDataIronMine ();
